...
const csp = [
  ...
  "media-src 'self' blob:",
  "font-src 'self' data:",
  "connect-src 'self' https://*.supabase.co https://api.pusula.tr https://pusula-api-1x9a.onrender.com https://*.onrender.com https://app.posthog.com https://*.sentry.io wss://*.supabase.co",
